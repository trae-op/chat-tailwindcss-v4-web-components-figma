...
export class VideoConferenceComponent extends TailwindCssConnectionModule {
  ...
  attributeChangedCallback(
    ...
    if (shadow !== null && newValue !== null) {
      const pathElement = shadow.getElementById("js-path-video-conference");
      const svgElement = shadow.getElementById("js-svg-video-conference");
